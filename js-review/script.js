...
const count = book.reviews.librarything?.reviewsCount ?? "no data"; // if not 0 or ""
count;
...
// Array sort
const arr = [3, 7, 1, 9, 6];
const sorted = arr.sort((a, b) => a - b); // b - a for descending
sorted;
arr; // mutated the old array, so we slice() to make a copy of it
...
async function getTodos() {
  ...
  return data;
} // Return values of async function is always a promise
